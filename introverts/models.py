...
class Meals(models.Model):
    idMeal = models.IntegerField(primary_key=True)
    strMeal = models.CharField(max_length=128, blank=True, null=True)
    strDrinkAlternate = models.CharField(max_length=128, blank=True, null=True)
    strArea = models.CharField(max_length=128, blank=True, null=True)
    strCategory = models.CharField(max_length=128, blank=True, null=True)
    strInstructions = models.TextField(blank=True, null=True)
    strMealThumb = models.TextField(blank=True, null=True)
    strTags = models.CharField(max_length=128, blank=True, null=True)
    strYoutube = models.CharField(max_length=128, blank=True, null=True)
    ...
    strIngredient16 = models.CharField(max_length=128, blank=True, null=True)
    strIngredient17 = models.CharField(max_length=128, blank=True, null=True)
    strIngredient18 = models.CharField(max_length=128, blank=True, null=True)
    strIngredient19 = models.CharField(max_length=128, blank=True, null=True)
    strIngredient20 = models.CharField(max_length=128, blank=True, null=True)
    ...
    strMeasure16 = models.CharField(max_length=128, blank=True, null=True)
    strMeasure17 = models.CharField(max_length=128, blank=True, null=True)
    strMeasure18 = models.CharField(max_length=128, blank=True, null=True)
    strMeasure19 = models.CharField(max_length=128, blank=True, null=True)
    strMeasure20 = models.CharField(max_length=128, blank=True, null=True)
    strSource = models.CharField(max_length=128, blank=True, null=True)
    strImageSource = models.CharField(max_length=128, blank=True, null=True)
    strCreativeCommonsConfirmed = models.CharField(max_length=128, blank=True, null=True)
